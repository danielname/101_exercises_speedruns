/** SPEEDRUN RULES!
 * 1) TIME STARTS ON INITIAL COMMIT WITH COMMENT "READY SET GO"
 * 2) FIRST COMMIT SHOULD BE AT THE TURN OF A MINUTE
 * 3) COMMIT AFTER EVERY QUESTION THAT ENDS WITH THE NUMBER 1, COMMIT COMMENT SHOULD INCLUDE THE QUESTION NUMBER. THIS SHOULD INCLUDE 1, 11, 21, 31, 41, 51, 61, 71, 81, 91, AND 101.
 * 4) FINAL COMMIT SHOULD INCLUDE SECONDS IN THE COMMENT
 * 5) USER DOES NOT HAVE TO TEST FUNCTIONS UNTIL AFTER FINAL COMMIT, BUT IF THERE IS AN ERROR, RUN IS NULLIFIED OR AT LEAST NOT COMPLETE UNTIL GLITCH GIVES THE "ALL COMPLETE!"
 */
...
function isVowel(s){
    return s.toLowerCase() === 'a' || s.toLowerCase() === 'e' || s.toLowerCase() === 'i' || s.toLowerCase() === 'o' || s.toLowerCase() === 'u';
}
...
function endsWithVowel(s){
    let sArray = s.split('');
    return isVowel(sArray[sArray.length - 1]);
}
...
function startsAndEndsWithVowel (s){
    return startsWithVowel(s) && endsWithVowel(s);
}
...
function thirdToLast(i){
    if (typeof i === 'string'){
        let iArray = i.split('')
        return iArray[iArray.length -3];
    }
    return i[i.length - 3];
}
...
function median(a){
    if (a.length % 2 === 0){
        return mean([a[a.length/2],a[a.length/2 - 1]]
    }
...
function onlyPositiveNumbers(a){
    let emptyArray =[];
    for (let i=0; i<a.length; i++){
        if (isPositive(a[i])){
            emptyArray.push(a[i]);
...
function onlyNegativeNumbers(a){
    let emptyArray =[];
    for (let i=0; i<a.length; i++){
        if (!isPositive(a[i])){
            emptyArray.push(a[i]);
...
function onlyPositiveEvens(a){
    return onlyPositiveNumbers(onlyEvenNumbers(a));
}
...
function onlyPositiveOdds(a){
    return onlyPositiveNumbers(onlyOddNumbers(a));
}
...
function onlyNegativeEvens(a){
    return onlyEvenNumbers(onlyNegativeNumbers(a));
}
...
function onlyNegativeOdds(a){
    return onlyOddNumbers(onlyOddNumbers(a));
}
...
function shortestString(a){
    let short = ";;;;;;;;lnbfhkdijoklfdfiguheiruaphsfdrpewhgfiuhroeaifghufhiawefrioerwbfoiewrbnfjvknfsklvnfksldnvjkdsnfkdcs;lnbfhkdijoklfdfiguheiruaphsfdrpewhgfiuhroeaifghufhiawefrioerwbfoiewrbnfjvknfsklvnfksldnvjkdsnfkndskfnkdsanfvs";
    for (let i=0; i< a.length; i++){
...
function  getAverageBookPrice(a){
    return totalOfBookPrices(a) / a.length;
}
...
function highestPriceBook(a){
    let emptyObject = {price: 0};
    for (let i=0; i< a.length; i++){
        if (a[i].price > emptyObject.price){
            emptyObject = a[i];
        }
    }
    return emptyObject;
...
function lowestPriceBook(a){
    let emptyObject = {price: 99999999999999999999999999};
    for (let i=0; i< a.length; i++){
        if (a[i].price < emptyObject.price){
            emptyObject = a[i];
        }
...
function totalNumberOfItems(a){
    let sum = 0;
    for (let i=0; i< a.items.length; i++){
        sum += a.items[i].quantity;
    }
    return sum;
}
...
function getAverageItemPrice(a){
    let sum = 0;
    for (let i=0; i< a.items.length; i++){
        sum += a.items[i].price;
    }
...
function getAverageSpentPerItem(a){
    let sum = 0;
    for (let i=0; i< a.items.length; i++){
        sum += (a.items[i].quantity * a.items[i].price);
    }
    return sum / totalNumberOfItems(a);
}
...
function mostSpentOnItem (a){
    let emptyObject = {price: 0,
    quantity:0};
    for (let i=0; i< a.items.length; i++){
        if (a.items[i].price * a.items[i].quantity > emptyObject.price * emptyObject.quantity){
            emptyObject = a.items[i];
        }
    }
    return emptyObject;
}
